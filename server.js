...
var streams = bot.twit.stream('statuses/filter', { track: '@CyBotXD' });

var myDate = new Date();


streams.on('limit', function (limitMessage) {
  bot.twit.post('statuses/update', { status: "@CyrisXD " + "Limited " + myDate }, function (err, reply) { });
});

streams.on('warning', function (warning) {
   bot.twit.post('statuses/update', { status: "@CyrisXD " + "Warning " + myDate }, function (err, reply) { });
});


streams.on('reconnect', function (request, response, connectInterval) {
  bot.twit.post('statuses/update', { status: "@CyrisXD " + "Reconnected " + myDate }, function (err, reply) { });
});
...
streams.on('connect', function (request) {
    ...
    bot.twit.post('statuses/update', { status: "@CyrisXD " + "Online! " + myDate }, function (err, reply) { });
...
stream.start()
bot.twit.post('statuses/update', { status: "@CyrisXD " + "Disconnected " + myDate }, function (err, reply) { });
});
